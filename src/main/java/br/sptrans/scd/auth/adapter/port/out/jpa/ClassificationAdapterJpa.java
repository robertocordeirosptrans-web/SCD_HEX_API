...
import br.sptrans.scd.auth.adapter.port.out.jpa.mapper.ClassificationPersonMapper;
import br.sptrans.scd.auth.adapter.port.out.jpa.repository.ClassificationPersonRepository;
