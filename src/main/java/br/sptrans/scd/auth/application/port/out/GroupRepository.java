...
/**
 * Porta de Saída — repositório de Grupos.
 * Tabela principal: SPTRANSDBA.GRUPOS.
...
public interface GroupRepository {
    ...
    void updateGroup(String codGrupo, String codStatus, Long idUsuarioManutencao);
    ...
    /**
     * Atualiza COD_STATUS = 'I' em GRUPO_PERFIS para o par (codGrupo, codPerfil).
    ...
    /**
     * Conta quantos usuários ativos (COD_STATUS = 'A') estão vinculados ao grupo
     * via GRUPO_USUARIOS. Usado antes de inativar.
     */
