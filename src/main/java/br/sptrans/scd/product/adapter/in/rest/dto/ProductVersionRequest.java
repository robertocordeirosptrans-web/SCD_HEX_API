...
public record ProductVersionRequest(
                ...
                @NotNull(message = "Data de validade é obrigatória") LocalDateTime dtValidade,
                @NotNull(message = "Data de início da vida útil é obrigatória") LocalDateTime dtVidaInicio,
                @NotNull(message = "Data de fim da vida útil é obrigatória") LocalDateTime dtVidaFim,
